...
author: "due Thursday, November 17, 4pm"
output: 
  html_document:
    toc: true
    toc_float: true
...
To submit, you need to export your .html document from RStudio Cloud and then upload it to the AE 10 assignment on Brightspace.
