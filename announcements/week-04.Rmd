...
+ Reminder that your project topic does need to be tied loosely to "data for social good." Sports is not off limits, but should look different from a typical "sports analytics" project that. Some ideas:
