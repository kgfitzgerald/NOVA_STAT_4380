...
- Understanding your data - `glimpse()`, `summary()`
- Isolating data – `filter`, `select`, `arrange`
- Piping operator – `|>`
- Deriving information – `summarize`, `group_by`, `mutate`, `count`
- Conditional logic - `if_else`, `case_when`
- Combining datasets – `bind_rows`, `left_join`, `full_join`, etc
...
--
+ Using Reddit’s Application Programming Interface (API)
...
+ Creating a population heat map *Hint: use `state` data from `maps` package
