...
**Brightspace**: Gradebook, Submit assignments, Piazza
...
- Use **Piazza** (linked on Brightspace) for any questions about course content and/or assignments, since other students may benefit from the response. And it's easier to type code and math, compared to email.
