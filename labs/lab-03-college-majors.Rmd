...
+ You will be working in your Lab 03–04 Groups (see Brightspace).
+ Download the `.qmd` file for this lab from our class GitHub repo (linked on Brightspace)
...
::: {.callout-important}
Add code to your .qmd to load each of the relevant packages. You may need to install a package first if this is your first time using it.
:::
...
+ Take a look at the data (i.e., using `View()`:

    + What does one row represent?
    + What is the difference between `major` and `major_category`?
:::
...
To submit, you need to upload your lab-03.html file to the Lab 03 assignment on Brightspace. The html file should be located in the same folder on your computer where you placed your .qmd (STAT_4380). 

:::



Convert the final `.html` file to a .zip file and upload to Brightspace.
