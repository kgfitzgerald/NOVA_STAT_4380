---
title: "Lab 06: Data Importing & Cleaning"
...
+ You will work in your Lab 06–07 groups (see Brightspace).
...
Before submitting your `.html` (as a .zip file to Brightspace):
...
Render one last time, check the `.html` file for accuracy, then convert to .zip file to upload to Brightspace.
