...
+ Go to our class [GitHub repo](https://github.com/kgfitzgerald/NOVA_STAT_4380_templates) and download the `.qmd` file for this lab and the dataset `anes_subset.csv` from the data subfolder
