...
Unfortunately, Brightspace does not accept html file submissions. So, you will first need to turn it into a .zip file. 
...
+ Upload the .zip file to the Lab 01 assignment in Brightspace and submit
