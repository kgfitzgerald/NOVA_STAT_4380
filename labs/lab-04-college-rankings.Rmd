...
+ You will be working in your randomly assigned Lab 03 - 04 Groups. See Brightspace.
...
Before submitting your assignment on Brightspace, Render one last time, then open up your .html in a full window and inspect the following:
...
To submit, Render one last time and then upload your .html document to the relevant assignment on Brightspace. Refer back to [Lab 01](https://kgfitzgerald.github.io/NOVA_STAT_4380/labs/lab-01-hello-r.html) for detailed instructions on how to submit your assignment. 
